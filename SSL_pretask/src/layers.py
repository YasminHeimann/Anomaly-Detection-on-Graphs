...
class TPGCNBlock(Module):
    ...
    def forward(self, input, adj):
        ...
        x = self.transform_layers.forward(input, identity)
        return self.propagate_layers.forward(x, adj)

    def get_outdim(self):
        return self.propagate_layers.get_outdim()
