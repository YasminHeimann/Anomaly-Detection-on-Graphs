...
import collections
from src.ica.ica.utils import load_data, pick_aggregator, create_map, build_graph
from src.ica.ica.classifiers import LocalClassifier, RelationalClassifier, ICA
...
class ClusteringMachine(object):
    ...
    """
    def __init__(self, adj, features, cluster_number=20, clustering_method='kmedoids'):  # todo: was metis
        """
